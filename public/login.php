                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="txtemail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                            <!-- Trong file login.php -->
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="txtmatkhau" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <?php if (isset($thongbao)) : ?>
                                        <div class="thongbao invalid-feedback"><?php echo $thongbao; ?></div>
                                    <?php endif; ?>
                                    <hr>
                                    <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="index.php?action=dangky">Đăng ký!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
